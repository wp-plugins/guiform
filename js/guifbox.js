...
(function (b, c) {
    ...
    b.widget("guiform.guifbox", b.extend({}, a, {
        ...
        destroy: function () {
            this.element.removeData("guifbox").unbind(".guifbox");
            return b.guiform.guifbox.prototype.destroy.apply(this, arguments)
        },
        _maxscreen: function () {
            b("#guifbox-window").addClass("guifbox-maxscreen")
        },
        ...
        _build: function () {
            ...
            (this.options.status != "loading") ? b("#guifbox-header").append("<span class='icon-cancel-circled' id='guifbox-close'></span>") : b("#guifbox-close").remove();
