...
(function (a, b) {
    a.widget("GuiForm.form", {
        ...
        _init: function () {
            ...
            c.on("focus", "input, select, textarea", function () {
            ...
            c.on("click", '.f_phone input, input[class="validation[numeric]"]', function (e) {
                a(this).select()
            })
        },
        submit: function (g) {
