...
(function (a, b) {
  a.widget("GuiForm.form", {
    ...
    _create: function () {
      ...
      a("guiform", c).replaceTag("<select>", true);
      d.file_input();
      d.default_value();
      d.replaceText();
    ...
    file_input: function () {
      ...
      a(document).on("click", ".gui-file-remove", function (e) {
        var f = a(this).parents(".gui-file").attr("id").split("-")[1];
        var d = a(this).parents(".item").find("input").attr("name").split("[")[0];
        c.FileRemove(d, f)
      })
    },
