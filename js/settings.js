...
(function() {
	...
	$('.wp-list-table').on('click', '#save-mail, #update-mail', function(){
		...
		var data = {
					'action'          : 'guiform-mail-quick-save', 
					'id'              : id,
					'email'           : email,
					'name'            : name,
	...
	$('.wp-list-table').on('click', '.activation-key-button', function(){
		...
		var data = {
					'action' : 'guiform-send-activation-key',
					'id'     : id
				};
