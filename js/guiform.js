...
(function (a, b) {
    a.widget("GuiForm.guiTools", {
        ...
        _create: function () {
            ...
            f.on("blur", '#message-url textarea[name="message-url"]', function () {
        ...
        save: function (g) {
            ...
            if (e.size() == 0) {
                ...
                if (j > 0) {
                    ...
                    a(f).find("select").replaceTag("guiform");
                    ...
                    a(i).find(".item").removeClass("ui-draggable").removeAttr("data-name data-type");
                    ...
                    a(i).find("select").replaceTag("guiform");
                    a.each(e, function () {
...
(function () {
    ...
    a.htmlCanvas = function () {
        ...
        b("#container").find("guiform").replaceTag("select");
