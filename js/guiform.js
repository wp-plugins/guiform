...
(function (a, b) {
  a.widget("GuiForm.guiTools", {
    ...
    autoSave: function () {
      ...
      c.timer = setInterval(function (f) {
        var e = a(".ui-sortable .ui-draggable:not(.ui-sortable .ui-draggable.merge), .ui-sortable .merge-item");
        if(parseInt(guiBuilder.settings.autosave.value) == 1 && c.id != "" && e.size() > 0) {
          d.save("autosave")
        }
    ...
    _build: function () {
      ...
      if(a("#guiform-style").size() == 0) {
        var e = a("<style type='text/css' id='guiform-style' media='all' />");
        a("#canvas").prepend(e.clone());
        a("#guiform-style").html("#canvas, #canvas .ui-widget{background-color: #FFFFFF;font-family: Verdana,sans-serif;} #canvas .label{color: #333333;} #canvas input, #canvas textarea, #canvas .f_select [name]{border: 1px solid #CCCCCC;}")
      }
    ...
    _event: function () {
      ...
      d.on("keyup keydown", "#p_default_value", function (g) {
        var h = a.trim(a(this).val());
        var f = e._form();
        f.find("input[type='text'], textarea, select").attr("data-default", h)
      });
      ...
      d.on("click", "#p_visible", function (g) {
        var f = e._form();
        (a(this).is(":checked")) ? f.removeClass("hidden") : f.addClass("hidden")
      });
    ...
    submission_message: function () {
      var e = this;
      var c = this.options;
      var d = '<div id="message">	    							<ul class="list">	    								<li>	    									<label>	    										<input type="radio" name="message" value="default">	    										<span>Default thank you message</span>	    									</label>	    									<p class="description">After successful form submission, display default message.</p>	    								</li>	    								<li>	    									<label>	    										<input type="radio" name="message" value="redirect">	    										<span>Page redirect url</span>	    									</label>	    									<p class="description">After successful form submission, redirect to a custom url.</p>	    								</li>	    								<li>	    									<label>	    										<input type="radio" name="message" value="custom">	    										<span>Custom thank you message</span>	    									</label>	    									<p class="description">After successful form submission, display custom message.</p>	    								</li>	    							</ul>	    							<table id="message-url" style="width: 650px; display: none; height: 430px; border: 1px solid #21759B;"><tr>										<td style="padding: 10px; width: 200px; vertical-align: top; border: medium none;"><ul class="variable-fields" style="margin: 0 10px 0 0;"></ul></td>										<td style="padding: 10px; vertical-align: top; border: none;">											<h3>Custom Page Url</h3>	    								<p class="description">After successful form submission, redirect to a custom url.</p>	    								<textarea class="caret" style="width: 416px; height: 207px; resize: vertical;" name="message-url" placeholder="ex: http://domain-name.com/thankyou?entry={entry_id}">' + e.init.thank_you.url + '</textarea>										</td>										</tr></table>	    						  <table id="message-table" style="width: 800px; border: none; display: none; margin-bottom: 0px;"><tr>										<td style="padding: 0px; width: 285px; vertical-align: top; border: medium none;"><ul class="variable-fields" style="margin: 0 10px 0 0;"></ul></td>										<td style="padding: 0px; vertical-align: top; border: none;">											<textarea id="tinymce-message" name="content"></textarea>										</td>										</tr></table>	    						</div>';
      a("<div>").guifbox({
        ...
        closeButton: false,
        create: function () {
          var j = a(".ui-sortable .ui-draggable:not(.ui-sortable .merge):not(.ui-sortable .f_submit), .ui-sortable .merge-item");
          var h = "";
          var g = "<table id='field-list' width='850' cellpadding='5' cellspacing='5'>";
          var f = "</table>";
          var k = "";
          j.each(function () {
            if(a(".label", this).size() > 0) {
              var l = a.trim(a(this).find(".label").text().replace(/\*/gi, ""));
              h += "<li data-name='{" + a(this).attr("data-name") + "}'>" + l + "</li>";
              k += "<tr><td width='150'>" + l + "</td><td>{" + a(this).attr("data-name") + "}</td></tr>"
            }
          });
          h += '<li data-name="{entry_id}" title="Submission ID" style="-moz-user-select: none; cursor: default;">Submission ID</li>					<li data-name="{form_id}" title="Form ID">Form ID</li>					<li data-name="{form_title}" title="Form Title">Form Title</li>					<li data-name="{ip_address}" title="IP Address">IP Address</li>';
          a(".variable-fields").html(h);
          tinyMCE.init({
          ...
          a("#tinymce-message").val(e.init.thank_you.message);
          a('#message input[value="' + e.init.thank_you.checked + '"]').attr("checked", "checked");
          a("#guifbox-button").css("padding", "0");
          var i = '<button id="message-next">Next</button> <button id="message-close">Finish</button>';
          if(e.init.thank_you.checked == "redirect" || e.init.thank_you.checked == "custom") {
            a("#guifbox-button").html(i).css("padding", "10px")
          }
          else {
            a("#guifbox-button").html('<button id="message-close">Finish</button>').css("padding", "10px")
          }
    ...
    get_properties: function () {
      var c = this;
      var d = c._form();
      (d.hasClass("hidden")) ? a("#p_visible").removeAttr("checked") : a("#p_visible").attr("checked", "checked");
      ...
      if(d.hasClass("f_select")) {
        a("#p_default_value").attr("value", d.find("select").attr("data-default"))
      }
      ...
      if(d.hasClass("f_textarea") || d.hasClass("f_text") || d.hasClass("f_email")) {
        ...
        a("#p_default_value").attr("value", d.find("input[type='text'], select, textarea").attr("data-default"));
    ...
    save: function (g) {
      ...
      if(e.size() == 0) {
        ...
        if(j > 0) {
          ...
          a(f).find("select").replaceTag("<guiform>", true);
          ...
          a(i).find("select").replaceTag("<guiform>", true);
          a.each(e, function () {
            if(!a(this).hasClass("f_confirm_password") && !a(this).hasClass("f_list") && !a(this).hasClass("f_submit") && !a(this).hasClass("f_heading") && !a(this).hasClass("f_letter")) {
    ...
    properties: function (e, f) {
      ...
      a(".ui-sortable li.ui-draggable.active").hasClass("merge") ? a("#tab-li-group").show() : a("#tab-li-group").hide();
      if(d.hasClass("f_heading")) {
        c = ["Visible", "Text", "Sub Text", "Text Alignment", "Font Family", "Font Size"]
      }
      else {
        if(d.hasClass("f_letter")) {
          c = ["Visible", "Text Content", "Width", "Text Alignment", "Font Family", "Font Size", "Line Height"]
        }
        else {
          if(d.hasClass("f_list")) {
            c = ["Visible", "Width", "List Type", "Font Family", "Font Size", "Line Height"]
          }
          else {
            if(d.hasClass("f_text")) {
              c = ["Visible", "Label", "Input Mask", "Unique Value", "Label Width", "Default Value", "Placeholder", "Short Description", "Validation", "Width", "Maximum Input"]
            }
            else {
              if(d.hasClass("f_textarea")) {
                c = ["Visible", "Label", "Label Width", "Placeholder", "Default Value", "Short Description", "Height", "Width"]
              }
              else {
                if(d.hasClass("f_select")) {
                  c = ["Visible", "Label", "Label Width", "Default Value", "Short Description", "Width"]
                }
                else {
                  if(d.hasClass("f_radio") || d.hasClass("f_checkbox")) {
                    c = ["Visible", "Label", "Label Width", "Option Columns", "Width", "Options Text Width"]
                  }
                  else {
                    if(d.hasClass("f_submit")) {
                      c = ["Visible", "Submit Text", "Reset Text", "Loading Text", "Submit Alignment", "Show Reset Button", "Offset"]
                    }
                    else {
                      if(d.hasClass("f_file")) {
                        c = ["Visible", "Label", "Label Width", "Short Description", "Width", "Allow Multiple Upload", "File Extentions", "Max File Size"]
                      }
                      else {
                        if(d.hasClass("f_password")) {
                          c = ["Visible", "Label", "Label Width", "Short Description", "Width"]
                        }
                        else {
                          if(d.hasClass("f_confirm_password")) {
                            c = ["Visible", "Label", "Label Width", "Short Description", "Compare With", "Width"]
                          }
                          else {
                            if(d.hasClass("f_phone")) {
                              c = ["Visible", "Label", "Input Mask", "Label Width", "Short Description", "Width"]
                            }
                            else {
                              if(d.hasClass("f_email")) {
                                c = ["Visible", "Label", "Label Width", "Placeholder", "Default Value", "Short Description", "Width", "Maximum Input"]
                              }
                              else {
                                if(d.hasClass("f_spinner")) {
                                  c = ["Visible", "Label", "Label Width", "Short Description", "Maximum Value", "Minimum Value", "Width"]
                                }
                                else {
...
(function () {
  ...
  var a = {
    ...
    Form: {
      ...
      select: ["<label class='label'>Drop Down</label>																			<div class='wrap' style='width: 250px;'>																				<select name=''>																					<option value='Option 1'>Option 1</option>																					<option value='Option 2'>Option 2</option>																					<option value='Option 3'>Option 3</option>																				</select>																			</div>", "VARCHAR(150) NULL"],
      radio: ["<label class='label'>Radio Button</label>																			<div class='f_radio_wrap wrap'>																				<label><input type='radio' value='Option 1'><span>Option 1</span></label><br>																				<label><input type='radio' value='Option 2'><span>Option 2</span></label><br>																				<label><input type='radio' value='Option 3'><span>Option 3</span></label><br>																			</div>", "VARCHAR(150) NULL"],
      checkbox: ["<label class='label'>Check Box</label>																			<div class='f_checkbox_wrap wrap'>																				<label><input type='checkbox' value='Option 1'><span>Option 1</span></label><br>																				<label><input type='checkbox' value='Option 2'><span>Option 2</span></label><br>																				<label><input type='checkbox' value='Option 3'><span>Option 3</span></label><br>																			</div>", "VARCHAR(150) NULL"],
      file: ["<label class='label'>File Upload</label>										 		  						<div class='wrap' style='width: 250px;'>										 		  							<input type='file' file-maxsize='5' file-accept='jpg, jpeg, png, gif'>										 		  						</div>										 		  						<div class='gui-files'></div>", "TEXT NULL"],
      ...
      "switch": ["<label class='label'>Text Label</label>																			<div class='wrap'>																				<div class='switch'>																					<input type='radio' value='1' /><label>On</label>																					<input type='radio' value='0' /><label>Off</label>																				</div>																			</div>", "VARCHAR(150) NULL"]
    },
    Context: {
      menu: {
  ...
  a.htmlCanvas = function () {
    ...
    b("#container").find("guiform").replaceTag("<select>", true);
