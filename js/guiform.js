    ...
    a.widget("GuiForm.guiTools", {
        ...
        _build: function () {
            ...
            if (a("#guiform-style").size() == 0) {
                var e = "<style type='text/css' id='guiform-style' media='all'>    									#canvas, #canvas .ui-widget{background-color: #FFFFFF;											font-family: Verdana,sans-serif,guiform;											}											#canvas .label{											color: #333333;											}											#canvas input, #canvas textarea, #canvas select{											border: 1px solid #CCCCCC;											}										 </style>";
                a("#canvas").prepend(e)
            }
