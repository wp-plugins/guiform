...
(function (a, b) {
    a.widget("GuiForm.guiTools", {
        options: {
            ...
            Properties: {
                Label: "<input type='text' id='p_text_label' value='' placeholder=''>",
                "Defualt Value": "<input type='text' id='p_defual_value' value=''>",
                Placeholder: "<input type='text' id='p_placeholder' value=''>",
                "Short Description": "<input type='text' id='p_short_description' value='' placeholder=''>",
                ...
                "File Accept": "<input type='text' id='p_short_description' value='' placeholder=''>",
                ...
                Offset: "<div id='p_submit_offset'></div><div class='p_submit_offset_value'>Value :<span>0</span></div>",
        ...
        _event: function () {
            ...
            d.on("click", ".p_submit_alignment", function (g) {
                ...
                a(".p_submit_offset_value span").text("0")
            });
        ...
        tabs_properties: function (e) {
            ...
            (d.find(".label").text() !== "") ? a(".ui-tabs-nav a:eq(0)").text(d.find(".label").text()) : a(".ui-tabs-nav a:eq(0)").html("&nbsp;");
            if (d.hasClass("f_submit")) {
                a(".ui-tabs-nav a:eq(0)").text("Submit Button")
            }
            c.checked();
        ...
        get_properties: function () {
            ...
            if (d.hasClass("f_submit")) {
                ...
                a(".p_submit_offset_value span").text(d.find(".f_submit_wrap span").css("margin-left").replace("px", "")), a(".p_submit_alignment[value='" + d.find(".f_submit_wrap").css("text-align") + "']").attr("checked", "checked");
                ...
                a("#p_submit_offset").slider({
                    ...
                    slide: function (l, m) {
                        a(".p_submit_offset_value span").text(m.value);
        ...
        colors: function (e, f) {
            ...
            a(".basic").guifcolor({
                ...
                beforeShow: function (j) {
                    var l = this.id;
                    var k = a("#guiform-style").text();
                    if (l == "color") {
                        a(this).guifcolor("set", k.split(".label{color: ")[1].split(";")[0])
                    }
                    if (l == "backgroundColor") {
                        a(this).guifcolor("set", k.split("background-color: ")[1].split(";")[0])
                    }
                ...
                show: function (j) {
                    var k = a("#guiform-style").text().split("background-color: ")[1].split(";")[0];
                    ...
                    a(".transparent").click(function () {
                        var m = a("#guiform-style").text();
                        var l = m.split("background-color: ")[1].split(";")[0];
                        if (a(this).is(":checked")) {
                            a("#guiform-style").text(a("#guiform-style").text().replace(l, "transparent"));
                            a(".guif-active .guif-preview-inner").css("background-color", "transparent");
                            a(".guif-input").val("transparent")
                        } else {
                            a("#guiform-style").text(a("#guiform-style").text().replace(l, "#FFFFFF"));
                ...
                move: function (k) {
                    ...
                    a(".transparent").removeAttr("checked");
                    if (o == "color") {
                        var l = m.split(".label{color: ")[1].split(";")[0];
                        a("#guiform-style").text(a("#guiform-style").text().replace(l, k.toHexString()))
                    }
                    if (o == "backgroundColor") {
                        var j = m.split("background-color: ")[1].split(";")[0];
                        a("#guiform-style").text(a("#guiform-style").text().replace(j, k.toHexString()))
                    }
                    if (o == "borderColor") {
                        var n = m.split("border: ")[1].split(";")[0].split(" ")[2];
                        a("#guiform-style").text(a("#guiform-style").text().replace(n, k.toHexString()))
                    }
                }
            });
            this.checked()
        ...
        fonts: function (e, f) {
            ...
            a.each(this.options.Fonts, function (g, h) {
        ...
        properties: function (e, f) {
            ...
            if (d.hasClass("f_select") || d.hasClass("f_checkbox") || d.hasClass("f_radio")) {
                ...
                c = ["Label", "Input Mask", "Label Width", "Placeholder", "Short Description", "Placeholder Value", "Validation", "Alignment", "Width", "Maximum Input", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_textarea")) {
                c = ["Label", "Label Width", "Field Name", "Placeholder", "Short Description", "Height", "Width", "Alignment", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_select")) {
                c = ["Label", "Label Width", "Field Name", "Short Description", "Width", "Alignment", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_radio") || d.hasClass("f_checkbox")) {
                c = ["Label", "Label Width", "Field Name", "Alignment", "Option Columns", "Option Columns", "Width", "Alignment", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_submit")) {
                c = ["Defualt Value", "Submit Alignment", "Show Button", "Offset"]
            }
            if (d.hasClass("f_file")) {
                c = ["Label", "Label Width", "Field Name", "Placeholder", "Short Description", "Alignment", "Width", "Text Width", "Label Width", "Allow Multiple Upload", "File Extentions", "Max File Size"]
            }
            if (d.hasClass("f_password")) {
                c = ["Label", "Label Width", "Field Name", "Short Description", "Alignment", "Width", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_phone")) {
                c = ["Label", "Input Mask", "Label Width", "Short Description", "Placeholder Value", "Alignment", "Width", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_email")) {
                c = ["Label", "Label Width", "Placeholder", "Short Description", "Placeholder Value", "Alignment", "Width", "Maximum Input", "Text Width", "Label Width"]
            }
            if (d.hasClass("f_spinner")) {
                c = ["Label", "Label Width", "Short Description", "Maximum Value", "Minimum Value", "Alignment", "Width"]
            }
            if (d.hasClass("f_switch")) {
                c = ["Label", "Label Width", "Short Description", "Alignment", "Width", "Option 1", "Option 2"]
            }
        ...
        tab_groups: function () {
            ...
            e.find(".merge-item").each(function () {
                var h = this.id;
                var g = a(this).find(".label").text() || "Submit Button";
            ...
            a(document).on("click", "#group-list .delete", function () {
                var g = a(this).parent();
                f.remove(a("#item-" + g.attr("id").split("-")[1]), false);
        ...
        buildProperties: function (d) {
            ...
            a.each(this.options.Properties, function (e, f) {
                c += (a.inArray(e, d) > -1) ? "<tr><td style='width:200px;' class='prop-label'>" + e + "</td><td class='prop-value'>" + f + "</td><tr>" : ""
            });
            c += "</table>";
        ...
        c.prototype.build = function () {
            ...
            setInterval(function (i) {
                ...
                if (b(".f_submit_wrap").size() > 0 && b(".f_submit_wrap input:eq(0)").css("margin-left").replace("px", "") < 1) {
                    ...
                    b(".p_submit_offset_value span").text("0")
                }
                b("#canvas").css({
                    height: b("body").innerHeight() - b("#canvas").offset().top - 70
                });
