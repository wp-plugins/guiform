    ...
    a.widget("GuiForm.guiTools", {
        ...
        get_properties: function () {
            ...
            if (d.hasClass("f_radio") || d.hasClass("f_checkbox")) {
                ...
                a("#p_options_label").val(d.find(".clearfix").innerWidth())
            }
                        ...
                        if (!a(this).hasClass("f_submit") && !a(this).hasClass("f_heading") && !a(this).hasClass("f_letter")) {
                            ...
                            if (q == "f_email") {
                                ...
                                if (q == "f_text") {
                                    ...
                                    if (q == "f_file") {
                                        h[this.id].validation.extension = a.map(a("input", this).attr("file-accept").split(","), function (t) {
                                            return a.trim(t)
                                        });
