    ...
    a.widget("GuiForm.guiTools", {
        options: {
            ...
            Icons: {
                ...
                "Operating System": {
                    Android: '<span title="Left" data-icon="&#xe028;"></span>',
                    Apple: '<span title="Center" data-icon="&#xe019;"></span>',
                    Linux: '<span title="Right" data-icon="&#xe0c0;"></span>',
                    Windows: '<span title="Justify" data-icon="&#xe020;"></span>'
                },
                "Content Management System": {
                    Blogger: '<span title="Left" data-icon="&#xe018;"></span>',
                    Drupal: '<span title="Center" data-icon="&#xe017;"></span>',
                    Joomla: '<span title="Right" data-icon="&#xe0d3;"></span>',
                    WordPress: '<span title="Justify" data-icon="&#xe0b7;"></span>'
                }
            }
        },
        init: guiform,
        ...
        tab_groups: function () {
            ...
            e.find(".merge-item").each(function () {
                ...
                d += "<li id='li-" + h.split("-")[1] + "' class='clearfix'>				          <span class='label'>" + g + "</span>									<span data-icon='&#xe08c;' class='move'></span>									<span data-icon='&#xe004;' class='add'></span>									<span data-icon='&#xe093;' class='delete'></span>								 </li>"
            });
