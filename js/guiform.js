...
(function () {
  ...
  $.fn.replaceTag = function (f, e) {
    ...
    for(c = 0; c < a; c++) {
      ...
      $newTag.html(currentElem.innerHTML)
        .replaceAll($currentElem);
      b.pushStack($newTag)
    }
    return this
  };
  ...
  $.browser = {
    ...
    agent: function () {
      if(this.object()
        .indexOf("msie") > -1) {
        return "msie/" + this.object()
          .split("msie ")[1].split(";")[0]
      } else {
        if(this.object()
          .indexOf("chrome") > -1) {
          return "chrome/" + this.object()
            .split("chrome/")[1].split(" ")[0]
        } else {
          if(this.object()
            .indexOf("safari") > -1) {
            return "safari/" + this.object()
              .split("version/")[1].split(" ")[0]
          } else {
            if(this.object()
              .indexOf("opera") > -1) {
              return "opera/" + this.object()
                .split("opera/")[1].split(" ")[0]
            } else {
              return "firefox/" + this.object()
                .split("firefox/")[1]
            }
          }
        }
  ...
  $.guiform = {
    emails: function (b, d) {
      d = d || "";
      if($(guiBuilder.emails)
        .size() > 0) {
        var e = $(".f_email")
          .map(function (f) {
            var g = [[$("input", this)
              .attr("name"), $("label", this)
              .text()]];
            return g
          })
          .get();
        var a = $(".f_text input[class='validation[email]']")
          .map(function (f) {
            var g = [[$(this)
              .attr("name"), $(this)
              .parents(".item")
  ...
  a.widget("GuiForm.guiTools", {
    ...
    _build: function () {
      ...
      a("#header")
        .append(d);
      a("#header ul")
        .css("min-width", a("#wpadminbar")
          .width() - (a("#adminmenuwrap")
            .width() + 35));
      if(a("#guiform-style")
        .size() == 0) {
    ...
    _create: function () {
      ...
      f.on("click", '#message input[name="message"]', function () {
        ...
        if(i == "defualt") {
          a("#guifbox-button")
            .html('<button id="message-close">Finish</button>')
            .css("padding", "10px")
        } else {
          if(i == "redirect") {
            a("#guifbox-button")
      ...
      f.on("click", "#message-next", function () {
        ...
        a("#message .list")
          .hide();
        if(i == "redirect") {
          a("#message #message-table")
            .hide();
          a("#message #message-url")
            .show()
        } else {
          if(i == "custom") {
            a("#guifbox-window")
        ...
        a("#guifbox-button")
          .html(h);
        var k = (a(document)
          .width() - a("#guifbox-window")
          .width()) / 2;
        var j = (a(window)
          .height() - a("#guifbox-window")
          .height()) / 2;
        a("#guifbox-window")
          .css({
            left: k,
      ...
      f.keydown(function (l) {
        ...
        if(a(".ui-tabs")
          .size() > 0) {
          if(m == "body" && o == 0 && a("#window-properties")
            .size() == 0) {
            return false
          }
        }
        if(o > 0) {
          var i = a("#fonts-container li")
            .index(a("#fonts-container li.active"));
          if(k == 38) {
            if(i == 0) {
              return false
            }
            a("#fonts-container ul")
              .scrollTop(i * 27 - 164);
            a("#fonts-container li:eq(" + i + ")")
              .removeClass("active");
            a("#fonts-container li:eq(" + (i - 1) + ")")
              .addClass("active")
          }
          if(k == 40) {
            a("#fonts-container ul")
              .scrollTop(i * 27 - 108);
            if(i >= a("#fonts-container li")
              .size() - 1) {
              return false
            }
            a("#fonts-container li:eq(" + i + ")")
          ...
          var h = a("#fonts-container li.active")
            .attr("data-value")
            .replace(/"/g, "'");
          var n = a("#guiform-style")
            .text();
          n = n.split("font-family: ")[1].split(";")[0];
          a("#guiform-style")
            .text(a("#guiform-style")
              .text()
              .replace(n, h))
        }
      })
        .keyup(function (m) {
          ...
          var j = ["input", "textarea", "select"];
          var o = a("#fonts-container")
            .size();
          var h = a("#fonts-container ul")
            .scrollTop();
          if(a(".ui-tabs")
            .size() > 0) {
            if(n == "body" && o == 0 && a("#window-properties")
              .size() == 0) {
              return false
            }
          }
          if(a.inArray(n, j) == -1 && o == 0) {
            if(k == 46) {
              ...
              if(m.ctrlKey == false && a(".ui-sortable .ui-draggable")
                .size() > 0) {
                if(l.size() > 0) {
                  var i = a(".ui-sortable .ui-draggable")
                    .index(l);
                  if(k == 37 || k == 38) {
                    if(i == 0) {
                      return false
                    }
                    a(".ui-sortable .ui-draggable:eq(" + i + ")")
                      .removeClass("active");
                    a(".ui-sortable .ui-draggable:eq(" + (i - 1) + ")")
                      .addClass("active")
                  }
                  if(k == 39 || k == 40) {
                    if(i >= a(".ui-sortable .ui-draggable")
                      .size() - 1) {
                      return false
                    }
                    a(".ui-sortable .ui-draggable:eq(" + i + ")")
                  ...
                  a(window)
                    .scrollTop(a(".ui-sortable li.ui-draggable.active")
                      .position()
                      .top + 40)
                } else {
                  if(k >= 37 && k <= 40) {
                    a(".ui-sortable .ui-draggable:eq(0)")
                      .addClass("active")
                  }
                }
                g.tabs_properties()
      ...
      f.on("click", "#fonts-container li", function () {
        a("#fonts-container li")
          .removeClass("active");
        a(this)
          .addClass("active");
        var i = a("#guiform-style")
          .text();
      ...
      f.on("mousedown", ".ui-sortable .ui-draggable", function (h) {
        ...
        if(h.ctrlKey) {
          ...
          a(".merge-item.active")
            .removeClass("active");
          a(".ui-sortable li.ui-draggable.active")
            .removeClass("active")
            .addClass("selected");
          if(a(this)
            .hasClass("selected")) {
      ...
      f.on("click", ".edit-label", function () {
        ...
        var i = a(this)
          ...
          .attr("id");
        a(this)
          .removeClass("edit-label");
        a(this)
          .html("<input id='" + i + "' class='edit-label-input' value=''>");
        a(this)
          .find("input")
          .focus();
        a(this)
      ...
      f.on("keydown", ".edit-label-input", function (i) {
        ...
        .on("keyup", ".edit-label-input", function (k) {
          ...
          var j = (a(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? a(".ui-sortable .merge-item.active") : a(".ui-sortable li.ui-draggable.active");
          var i = (a("#item-" + l)
            .find(".required")
            .size() > 0) ? a.trim(this.value) + "<span class='required'>*</span>" : a.trim(this.value);
          a("#item-" + l)
            .find(".label")
            .html(i);
          if(l == j.attr("id")
      ...
      f.on("click", "#options-list .add", function () {
        ...
        a("#options-list li:eq(" + h + ")")
          .after(i);
        a("#options-list .selected")
    ...
    _form: function () {
      return(a(".ui-sortable li.ui-draggable.active")
        .hasClass("merge")) ? a(".ui-sortable .merge-item.active") : a(".ui-sortable li.ui-draggable.active")
    },
    _event: function () {
      var c = this.options;
      ...
      a("#header")
        .on("click", "li", function (g) {
          ...
          case "delete":
            ...
            break;
          case "properties":
            var f = (a(".ui-sortable li.ui-draggable.active")
              .hasClass("merge")) ? a(".ui-sortable .merge-item.active") : a(".ui-sortable li.ui-draggable.active");
      ...
      d.on("keyup keydown", "#p_placeholder", function (g) {
        var h = a.trim(a(this)
          .val());
        var f = e._form();
        f.find("input[type='text'], textarea")
          .attr("placeholder", h)
      });
      ...
      d.on("keyup keydown", "#p_text", function (h) {
        ...
        (i !== "") ? a(".ui-tabs-nav a:eq(0)")
          .text(i) : a(".ui-tabs-nav a:eq(0)")
          .html("&nbsp;");
      ...
      d.on("keyup keydown", "#p_text_content", function (i) {
        ...
        var f = a.trim(g.html());
        (j !== "") ? a(".ui-tabs-nav a:eq(0)")
          .text(j) : a(".ui-tabs-nav a:eq(0)")
          .html("&nbsp;");
        h.find("p")
          .remove();
        var k = "";
      ...
      d.on("keyup keydown", "#p_sub_text", function (h) {
        ...
        g.find(".sub-text")
          .remove();
        g.find(".wrap")
          .append("<div class='sub-text'>" + f.html() + "</div>")
      });
      d.on("change keyup", "#p_fonts", function (g) {
        var f = e._form();
        f.find(":header, p, li")
          .css("font-family", a(this)
            .val())
      });
      ...
      d.on("keyup keydown", "#p_reset_text", function (h) {
        ...
        g.find("button[type='reset']")
          .html(f.html())
      });
      d.on("keyup keydown", "#p_loading_text", function (h) {
        var g = e._form();
        var f = a.cleanTags(this.value, "span, strong, i, u");
        g.find("button[type='submit']")
          .attr("data-loader", f.html())
      });
      ...
      d.on("click", ".p_submit_alignment", function (g) {
        ...
        f.find(".f_submit_wrap span")
          .css("margin-left", "");
        f.find(".f_submit_wrap")
          .css("text-align", a(this)
            .val());
        a(".p_submit_offset_value span")
          .text("0px")
      });
      d.on("click", ".p_show_reset", function (h) {
        var g = e._form();
        var i = this.value;
        g.find(".f_submit_wrap span")
          .css("margin-left", "");
        a("#p_submit_offset")
          .slider("option", "value", 0);
        if(a(this)
          .is(":checked")) {
          var f = a.trim(a("#p_reset_text")
            .val());
          g.find('button[type="submit"]')
            .before('<button name="reset" type="reset">' + (f == "" ? "Clear Form" : f) + "</button>")
        } else {
          g.find('button[type="reset"]')
            .remove()
        }
      ...
      d.on("click", "#p_multiple_file", function (g) {
        ...
        if(a(this)
          ...
          f.parents(".guif-dropzone")
            .prepend("<span>Add File</span>");
      ...
      d.on("click", "#p_unique_value", function (g) {
        var f = e._form();
        (a(this)
          .is(":checked")) ? a("input", f)
          .attr("data-unique", "true") : a("input", f)
          .attr("data-unique", "false")
      });
    ...
    spinner: function (d, f) {
      ...
      var c = e._form();
      if(f == "p_spinner_max") {
        c.find(".ui-spinner-input")
          .attr("data-max", d);
        c.find(".ui-spinner-input")
          .spinner("option", "max", d)
      } else {
        if(f == "p_label_width") {
          c.not(".shrink, .top-align")
            .find(".label")
            .css("width", d)
        } else {
          if(f == "p_spinner_min") {
            c.find(".ui-spinner-input")
              .attr("data-min", d);
            c.find(".ui-spinner-input")
              .spinner("option", "min", d)
          } else {
            if(f == "p_max_input") {
              c.find("input[type='text'], textarea")
                .attr("maxlength", d)
            } else {
              if(f == "p_max_size") {
                ...
                if(f == "p_height") {
                  ...
                  if(f == "p_width") {
                    c.find("input[type='password'], input[type='text'], input[type='file'], textarea, select, .wrap")
                      .css("width", d)
                  } else {
                    if(f == "p_columns") {
                      e.options_column(d)
      ...
      a("<div>")
        .guifbox({
          ...
          create: function () {
            ...
            i.each(function () {
              if(a(".label", this)
                ...
                var k = a.trim(a(this)
                  ...
                  .text()
                  .replace(/\*/gi, ""));
                g += "<li data-name='{" + a(this)
                  .attr("data-name") + "}'>" + k + "</li>";
                j += "<tr><td width='130'>" + k + "</td><td>{" + a(this)
                  .attr("data-name") + "}</td></tr>"
              }
            });
            ...
            a("#tinymce-message")
              .val(d.init.thank_you.message);
            a('#message input[value="' + d.init.thank_you.checked + '"]')
    ...
    options_column: function (f) {
      ...
      if(e.hasClass("f_radio") || e.hasClass("f_checkbox")) {
        ...
        if(f == 1 || f == "" || f == 0) {
          ...
          var c = parseInt(e.find(".wrap label")
            .size() / g);
          for(var d = 0; d < c; d++) {
            e.find(".wrap label:eq(" + (g - 1) + ")")
              .after("<br>");
            g += parseInt(f)
          }
        }
        e.find(".f_radio_wrap")
          .removeAttr("class")
          .addClass("f_radio_wrap wrap column[" + f + "]");
        e.find(".f_checkbox_wrap")
          .removeAttr("class")
          .addClass("f_checkbox_wrap wrap column[" + f + "]");
        if(f == "") {
          e.find(".f_radio_wrap, .f_checkbox_wrap")
            .removeClass("column[]")
        }
      }
    },
    tabs_style: function (e) {
      var g = this;
      var f = g._form();
      var c = (f.size() > 0) ? '<li><a href="#tab-properties">' + f.find("label")
        .text() + "</a></li>" : '<li style="display: none;"><a href="#tab-properties">Properties</a></li>';
    ...
    tabs_properties: function (e) {
      ...
      var i = (d.size() > 0) ? '<li id="tab-li-properties"><a href="#tab-properties">' + d.find(".label")
        .text() + "</a></li>" : '<li style="display: none;"><a href="#tab-properties">Properties</a></li>';
      ...
      (d.hasClass("f_list")) ? a("#tab-li-items")
        .show() : a("#tab-li-items")
        .hide();
      (d.hasClass("f_switch") || d.hasClass("f_select") || d.hasClass("f_checkbox") || d.hasClass("f_radio")) ? a("#tab-li-options")
        .show() : a("#tab-li-options")
        .hide();
      (a(".ui-sortable li.ui-draggable.active")
        .hasClass("merge")) ? a("#tab-li-group")
        .show() : a("#tab-li-group")
        .hide();
      (d.find(".label")
        .text() !== "") ? a(".ui-tabs-nav a:eq(0)")
        .text(d.find(".label")
          .text()) : a(".ui-tabs-nav a:eq(0)")
        .text(d.find(":header")
          .text() || d.find("p")
    ...
    tabs_mail: function (d) {
      ...
      a("<div>")
        .guifbox({
          ...
          save: function () {
            if(d == 0) {
              e.init.notification.notify = a('#tab-notification input[name="notify"]')
                .is(":checked") ? true : false;
              e.init.notification.subject = a.trim(a('#tab-notification input[name="subject"]')
                .val());
              e.init.notification.sender = a.trim(a('#tab-notification select[name="sender"]')
                .val());
              e.init.notification.mailto = a.trim(a('#tab-notification input[name="mailto"]')
                .val());
              e.init.notification.message = tinyMCE.get("tinymce-notification")
                .getContent();
              a(".tabs")
                .tabs("destroy")
                .tabs();
    ...
    get_properties: function () {
      ...
      (d.find(".required")
        .size() > 0) ? a("#required")
        .addClass("on") : a("#required")
        .removeClass("on");
      if(d.hasClass("f_heading")) {
        var g = a.cleanTags(d.find(":header")
          .html(), "span, em, u, blockquote, a, strong, i");
        var n = a.cleanTags(d.find(".sub-text")
          .html(), "span, em, u, blockquote, a, strong, i");
        a("#p_text")
          .val(g.html());
        a("#p_font_size")
        ...
        a("#p_sub_text")
          .val(n.html());
        a("input[name='p_alignment'][value='" + d.find(".wrap")
          .css("text-align") + "']")
          .attr("checked", "checked")
      }
      ...
      if(d.hasClass("f_text")) {
        a(".p_validation[value='" + d.find('input[type="text"]')
          .attr("class")
          .split("[")[1].split("]")[0] + "']")
          .attr("checked", "checked");
        (a("input", d)
          .attr("data-unique") == "true") ? a("#p_unique_value")
          .attr("checked", "checked") : a("#p_unique_value")
          .removeAttr("checked")
      }
      if(d.hasClass("f_text") || d.hasClass("f_phone")) {
        a("#p_input_mask")
          .val(d.find('input[type="text"]')
            .attr("data-mask"))
      }
      if(d.find(".short-description")
        .size() > 0) {
        var h = a.cleanTags(d.find(".short-description")
          .html(), "span, b, strong, i, em, u, br, blockquote, a");
        a("#p_short_description")
          .val(h.html())
      }
      var l = a("<div />")
        .append(d.find(".label")
      ...
      if(d.hasClass("f_textarea") || d.hasClass("f_text") || d.hasClass("f_email")) {
        a("#p_placeholder")
          .attr("value", d.find("input[type='text'], textarea")
            .attr("placeholder"));
        a("#p_max_input")
          .attr("value", d.find("input[type='text'], textarea")
            .attr("maxlength"))
      ...
      if(d.hasClass("f_textarea")) {
        a("#p_height")
          .attr("value", d.find("textarea")
            .outerHeight())
      }
      a("#p_width")
        .attr("value", d.find(".wrap")
          .outerWidth());
      if(d.hasClass("f_radio") || d.hasClass("f_checkbox")) {
        var e = d.find(".f_radio_wrap, .f_checkbox_wrap")
          .attr("class")
          .split("[")[1];
        (e === b) ? a("#p_columns")
          .val(1) : a("#p_columns")
          .val(e.split("]")[0]);
        a("#p_options_label")
          .val(d.find(".wrap label")
            .innerWidth())
      }
      a(".p_alignment[value='" + d.find(".label")
        .css("text-align") + "']")
        .attr("checked", "checked");
      if(d.hasClass("top-align")) {
        a(".p_alignment[value='top']")
          .attr("checked", "checked")
      }
      a("#p_label_width")
        .val(d.find(".label")
      ...
      if(d.hasClass("shrink") || (d.hasClass("shrink") && d.hasClass("expand"))) {
        ...
        var k = d.find(".ui-spinner-input")
          .attr("data-max");
        var f = d.find(".ui-spinner-input")
          .attr("data-min");
        a("#p_spinner_max")
          .val(k);
        a("#p_spinner_min")
      ...
      if(d.hasClass("f_file")) {
        ...
        a("#p_file_extensions")
          .val(a("input", d)
            .attr("file-accept"));
        (a("input", d)
          .attr("multiple") == "multiple") ? a("#p_multiple_file")
          .attr("checked", "checked") : a("#p_multiple_file")
          .removeAttr("checked")
      }
      if(d.hasClass("f_submit")) {
        var j = a.cleanTags(d.find("button[type='submit']")
          .html(), "span, strong, i, u");
        var i = a.cleanTags(d.find("button[type='reset']")
          .html(), "span, strong, i, u");
        var m = a.cleanTags(d.find("button[type='submit']")
          .attr("data-loader"), "span, strong, i, u");
        a("#p_submit_text")
          .val(j.html());
        a("#p_reset_text")
          .val(i.html());
        a("#p_loading_text")
          .val(m.html());
        a(".p_submit_offset_value span")
          .text(d.find(".f_submit_wrap span")
            .css("margin-left")), a(".p_submit_alignment[value='" + d.find(".f_submit_wrap")
            .css("text-align") + "']")
          .attr("checked", "checked");
        if(d.find("button[type='reset']")
          .size() > 0) {
          a(".p_show_reset[name='reset']")
            .attr("checked", "checked")
        }
        a("#p_submit_offset")
          .slider({
            range: "max",
            min: 0,
            value: d.find(".f_submit_wrap span")
              .css("margin-left")
              .replace("px", ""),
            max: d.width() - d.find(".f_submit_wrap span")
              .width(),
            start: function (p, q) {
              var o = d.find(".f_submit_wrap span")
                .width();
              d.find(".f_submit_wrap")
                .css("text-align", "");
              a(".p_submit_alignment")
                .removeAttr("checked");
              a(this)
                .slider("option", "max", d.width() - o)
            },
            slide: function (o, p) {
              a(".p_submit_offset_value span")
                .text(p.value + "px");
              d.find(".f_submit_wrap span")
                .css("margin-left", p.value - 1)
            }
          })
      }
      a(".prop-value .switch")
    ...
    code: function () {
      ...
      if(k.id) {
        ...
        var j = 0;
        a("#canvas .ui-sortable li.ui-draggable")
          .each(function () {
            j += a(this)
              .outerHeight(true)
          });
    ...
    data: function () {
      ...
      guiform.title = a.trim(a("#formName")
        .val());
    ...
    save: function (g) {
      ...
      if(e.size() == 0) {
        ...
        if(j > 0) {
          ...
          var h = {};
          var k = a.trim(a("#formName")
            .val());
          var d = ["f_submit"];
          a("#canvas .switch")
            .buttonset("destroy");
          a("#canvas .ui-spinner-input")
            .spinner("destroy");
          var f = a("<div />")
            .append(a("#container")
              .clone());
          ...
          a(i)
            ...
            .removeAttr("data-name data-type");
          a(i)
            .find(".ui-sortable")
            .css("min-height", "")
            .removeClass("ui-state-default ui-droppable ui-sortable");
          a(i)
            .find(".ui-draggable")
            .removeAttr("style data-name");
          a(i)
            .find(".ui-resizable-handle")
            .remove();
          a.each(e, function () {
            if(!a(this)
              .hasClass("f_list") && !a(this)
              .hasClass("f_submit") && !a(this)
              .hasClass("f_heading") && !a(this)
              .hasClass("f_letter")) {
              var o = a(this)
                .attr("data-name");
              ...
              if(q == "f_email") {
                h[this.id].validation.text = a("input", this)
                  .attr("class")
                  .split("[")[1].split("]")[0];
                ...
                if(q == "f_text") {
                  ...
                  h[this.id].validation.unique = (a("input", this)
                    .attr("data-unique") == "true") ? true : false
                } else {
                  if(q == "f_file") {
                    h[this.id].validation.extension = a.map(a("input", this)
                      .attr("file-accept")
                      .split(","), function (s) {
                        return a.trim(s)
                      });
                    h[this.id].validation.maxsize = a("input", this)
                      .attr("file-maxsize");
                    h[this.id].properties.multiple = a("input", this)
                      .hasAttr("multiple") ? true : false
                  }
                }
              }
            }
              ...
              if(p.status == "error") {
                ...
                if(g == "preview") {
                  ...
                  a("#guifbox")
                    .remove();
                  a("#window-preview")
                    .attr("href", guiBuilder.preview_url + p.id)
                    .trigger("click");
                  a("#thickbox-preview")
                    .attr("href", n)
                    .trigger("click")
    ...
    preview_screen: function (d) {
      ...
      if(d == 0) {
        a("#TB_window iframe")
          .contents()
          .find("#responsive-style")
          .remove()
      } else {
        if(d > 0 && d < 4) {
          a("#TB_window iframe")
            .contents()
            .find("#responsive-style, .error-message")
            .remove();
          a("#TB_window iframe")
            .contents()
            .find("head")
            .append('<link id="responsive-style" media="all" type="text/css" href="' + guiBuilder.plugins_url + 'css/responsive.css" rel="stylesheet">')
        } else {
          a("#window-preview")
            .get(0)
            .click()
    ...
    merge: function (e, f) {
      var d = this;
      if(a("#canvas .ui-draggable.selected")
        .size() < 2) {
        a("<div>")
          .guifbox({
            title: "message",
        ...
        var c = a("<div />");
        a("#canvas .selected:not(#canvas .merge), #canvas .selected .merge-item")
          .each(function () {
            a(".switch", a(this))
              .buttonset("destroy");
            a(".ui-spinner-input", a(this))
              .spinner("destroy");
            a(this)
              .removeClass("merge-item");
            var j = a(this)
              .attr("class");
            var i = a(this)
              .attr("id");
            ...
            var h = a(this)
              .attr("data-type");
            a(c)
              .append("<div id='" + i + "' data-type='" + h + "' data-name='" + g + "' class='merge-item " + j + "'>" + a(this)
                .html() + "</div>")
          });
        a(c)
          .find(".selected")
          .removeClass("selected ui-draggable");
        a("#canvas .selected:eq(0)")
          .attr("id", "item-merge-" + String(Math.random())
            .substring(2, 8));
        a("#canvas .selected:eq(0)")
          .removeClassRegEx(/^f_/)
        ...
        a("#canvas .selected:eq(0)")
          .html(c.html())
          .removeClass("selected")
          .addClass("active merge");
        a("#canvas .active.merge")
          .find(".merge-item:eq(0)")
          .addClass("active");
        a("#canvas .active.merge")
          .find(".switch")
          .each(function () {
    ...
    remove: function (f, e) {
      ...
      if(e !== b) {
        d = e;
        h = (h.find(".merge-item.active")
          .size() > 0) ? a(".ui-sortable li.ui-draggable.active .merge-item.active") : a(".ui-sortable li.ui-draggable.active");
        h.removeClass("active")
      } else {
        if(h.hasClass("merge")) {
          d = (h.find(".merge-item.active")
            .size() > 0) ? a(".ui-sortable li.ui-draggable.active .merge-item.active") : a(".ui-sortable li.ui-draggable.active")
        } else {
          d = a("#canvas .ui-draggable.active")
        }
      }
      var c = (h.hasClass("merge")) ? a(".ui-sortable .ui-draggable.merge.active")
        .index(d) : a(".ui-sortable .ui-draggable")
        .index(d);
      if(a(".ui-sortable li.ui-draggable.active")
        .hasClass("merge")) {
        var i = a(".ui-sortable .merge.active .merge-item")
          .size() - 1
      } else {
        var i = a(".ui-sortable .ui-draggable")
          .size() - 1
        ...
        d.slideUp(800, function () {
          ...
          if(a(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) {
            if(c < i) {
              a(".ui-sortable .merge.active .merge-item:eq(" + c + ")")
                .addClass("active")
            } else {
              if(i == 0) {
                a(".ui-sortable .merge.active")
                  .remove();
                a(".ui-sortable .ui-draggable:eq(" + c + ")")
                  .addClass("active");
                if(a(".ui-sortable li.ui-draggable.active")
                  .hasClass("merge")) {
                  a(".ui-sortable .merge.active .merge-item:eq(0)")
                    .addClass("active")
                }
              }
            }
      ...
      a(".basic")
        .guifcolor({
          ...
          beforeShow: function (g) {
            ...
            a(".guif-cancel, #transparent-wrapper")
              .remove();
            if(h == "backgroundColor") {
              a(".guif-button-container")
                .append('<span id="transparent-wrapper"><input type="checkbox" class="transparent" name=""><label>Transparent</label></span>')
            }
          },
          show: function (g) {
            var h = a("#guiform-style")
              .text()
              .split("background-color: ")[1].split(";")[0];
              ...
              .click(function () {
                ...
                if(a(this)
                  ...
                  a("#guiform-style")
                    .text(a("#guiform-style")
                      .text()
                      .replace(i, "transparent"));
                  a(".guif-active .guif-preview-inner")
    ...
    css: function (d, e) {
      ...
      a(".tabs #tab-css")
        .html(c);
      a(this.element[0])
        .addClass("guiEditable")
        .attr("contenteditable", true)
        .css({});
      if(a("#guiform-form")
        .size() == 0) {
        a("<style type='text/css' id='guiform-form' media='all'></style>")
          .insertAfter("#guiform-style")
      } else {
        a("#guiform-canvas")
          .val(a("#guiform-form")
            .text())
    ...
    tab_groups: function () {
      ...
      a("#group-list")
        .sortable({
          ...
          beforeStop: function (g, k) {
            ...
            var m = i.find("#" + h)
              .clone();
            var o = a("#group-list li")
              .size();
            i.find("#" + h)
              .remove();
            (c == (o - 2)) ? i.append(m) : a("div.merge-item:eq(" + c + ")", i)
              .before(m);
            if(a("#" + h)
              .hasClass("f_spinner")) {
              var l = a("#" + h)
      ...
      a(document)
        .on("click", "#group-list .delete", function () {
          var g = a(this)
            .parent();
    ...
    tab_items: function () {
      ...
      a(document)
        .on("click", "#items-list .delete", function () {
          var h = a(this)
            .parent();
        ...
        .on("click", "#items-list .add", function () {
          ...
          a("#items-list li:eq(" + h + ")")
            .after(i);
          a("#items-list .selected")
            .slideDown("slow", function () {
              a(this)
                .removeClass("selected")
            })
        ...
        f.find("select option")
          .each(function () {
            ...
            var k = a(this)
              .html();
            var i = (a(this)
              .is(":selected")) ? '<input checked="checked" type="radio" name="checked">' : '<input type="radio" name="checked">';
            if(j == k) {
      ...
      if(f.hasClass("f_switch")) {
        a("input", f)
          .each(function () {
            ...
            var l = a(this)
              .parent()
              .find("label[for='" + a(this)
                .attr("id") + "'] .ui-button-text")
              .html();
            var i = (a(this)
              .is(":checked")) ? '<input checked="checked" type="radio" name="checked">' : '<input type="radio" name="checked">';
            if(j == l) {
    ...
    rebuild_options: function () {
      ...
      e.build_options();
      if(d.hasClass("f_radio") || d.hasClass("f_checkbox")) {
        var c = d.find(".f_radio_wrap, .f_checkbox_wrap")
          .attr("class")
          .split("[")[1];
        c = (c === b) ? 1 : c.split("]")[0];
        e.options_column(c)
    ...
    build_options: function () {
      ...
      var h = this;
      var f = h._form();
      var c = a(".ui-sortable li.ui-draggable.active")
        .attr("data-name");
      var g = a("select, input", f)
        .attr("data-type");
      a("#options-list li")
        .each(function () {
          var i = a.trim(a('input[name="label"]', this)
            .val());
          var k = a('input[name="value"]', this)
            .val();
          var j = a('input[name="checked"]', this)
            .is(":checked");
          ...
          if(f.hasClass("f_checkbox")) {
            ...
            f.find(".f_checkbox_wrap")
              .html(e)
          }
          if(f.hasClass("f_switch")) {
            var l = "switch-" + String(Math.random())
              .substring(2, 8);
            e += "<input id='" + l + "' type='radio' " + j + " value='" + k + "' name='" + c + "' /><label for='" + l + "'>" + i + "</label>"
          }
        });
      if(f.hasClass("f_switch")) {
        e = a("<div class='switch'>")
          .append(e);
        f.find(".wrap")
          .html(e.clone());
        f.find(".switch")
    ...
    notification: function () {
      ...
      a.ajax({
        ...
        beforeSend: function () {
          a("#tab-notification")
            .html('<img style="display: block; margin: 110px auto auto;" src="' + guiBuilder.images + 'guif-loader.gif">');
          ...
          a("#tab-notification")
            .html(i);
          (d.init.notification.notify == true) ? a('#tab-notification input[name="notify"]')
            .attr("checked", "checked") : a('#tab-notification input[name="notify"]')
            .removeAttr("checked");
          a('#tab-notification select[name="sender"]')
            .val(d.init.notification.sender);
          ...
          f.each(function () {
            if(a(".label", this)
              ...
              var n = a.trim(a(this)
                ...
                .text()
                .replace(/\*/gi, ""));
              e += "<li data-name='{" + a(this)
                .attr("data-name") + "}'>" + n + "</li>";
              l += "<tr><td width='130'>" + n + "</td><td>{" + a(this)
                .attr("data-name") + "}</td></tr>"
            }
          });
          if(d.init.notification.message == "") {
            var m = g + l + h;
            a("#tinymce-notification")
              .val(m)
          } else {
            var j = a("<div />")
              .html(d.init.notification.message);
            j.find("#field-list")
              .html(l);
            a("#tinymce-notification")
              .val(j.html())
          ...
          a(".variable-fields")
            .html(e)
            .css("max-height", a(".variable-fields")
              .parent()
              .parent()
              .height());
          tinyMCE.init({
        ...
        success: function (e) {
          a("#tab-notification .loader")
            .remove();
          a("#tab-notification table")
            .show();
          a(".variable-fields")
...
(function () {
  ...
  a.htmlTools = function () {
    b(this.Selector.parent)
      .append(b(this.Container.tools));
  ...
  a.htmlCanvas = function () {
    if(guiBuilder.form !== null) {
      b("#GuiForm")
        .append(guiBuilder.form.canvas.replace(/\\/g, ""));
      b("#guiform-notice")
        .remove();
      b("#canvas ul.ui-sortable")
        .attr("id", "sortable")
    } else {
      b("#GuiForm")
        .append(b(this.Container.container));
      b("#container")
        .append(b(this.Container.canvas));
      b("#canvas")
        .html(b(this.Container.containment))
    }
  ...
  GuiForm = (function () {
    ...
    c.prototype.init = function () {
      ...
      a.htmlCanvas();
      b("body")
        .append(a.Container.contextMenu);
      b("body")
        .append("<span class='canvas-resize'><span class='arrow'></span><span class='canvas-info'></span></span>");
      this.build();
      b(document)
        .guiTools({
          title: a.title
    ...
    c.prototype.form = function (f) {
      ...
      var d = "field_" + String(Math.random())
        .substring(2, 6);
      var j = "item-" + String(Math.random())
        .substring(2, 8);
      var i = (f == "t_checkbox") ? "[]" : "";
      var e = b("<li></li>");
      e.html(a.Form[h][0])
        .addClass(f.replace("t_", "f_") + " ui-draggable blockLine expand clearfix selected item")
        .attr("data-name", d)
        .attr("data-type", a.Form[h][1])
        .attr("id", j)
        .find("input, select, textarea")
        .attr("name", d + i);
      (g.size()) ? g.after(e) : b("#canvas .ui-sortable")
        .append(e);
      if(h == "phone") {
        b('input[name="' + d + '"]')
          .attr("data-mask", "(###) ###-####")
        ...
        if(h == "spinner") {
          ...
          if(h == "switch") {
            e.find("input")
              .each(function () {
                var k = "switch-" + String(Math.random())
                  .substring(2, 8);
                b(this)
                  .attr("id", k);
                b(this)
    ...
    c.prototype.build = function () {
      ...
      b("#tools li")
        .draggable({
          ...
          zIndex: 2000,
          start: function (i, j) {
            b(".ui-draggable.ui-sortable-helper, .ui-sortable .ui-state-highlight")
              .remove();
            b(".ui-resizable-handle")
              .show();
            b("#contextMenu")
              .hide();
            a.draggingItem = true;
            ...
            b("#canvas ul#sortable")
              .sortable("option", "axis", "x,y")
          },
          stop: function (i, j) {
      ...
      b("#canvas ul#sortable")
        ...
        .sortable({
          ...
          start: function (k, l) {
            var i = "field_" + String(Math.random())
              .substring(2, 6);
            var n = "item-" + String(Math.random())
              .substring(2, 8);
            var m = (a.dragItemID == "t_checkbox") ? "[]" : "";
            var j = b("#canvas")
              .find(".ui-draggable[style*='display: none']");
            if(a.draggingItem == true) {
              j.html(a.Form[a.dragItem][0])
                .addClass(a.dragItemID.replace("t_", "f_") + " blockLine expand clearfix item")
                .attr("data-name", i)
                .attr("data-type", a.Form[a.dragItem][1])
                .attr("id", n)
                .find("input, select, textarea")
                .attr("name", i + m);
              if(a.dragItemID.replace("t_", "") == "phone") {
                ...
                if(a.dragItemID.replace("t_", "") == "spinner") {
                  ...
                  if(a.dragItemID.replace("t_", "") == "switch") {
                    j.find("input")
                      .each(function () {
                        var o = "switch-" + String(Math.random())
                          .substring(2, 8);
                        b(this)
                          .attr("id", o);
                        b(this)
            ...
            b(this)
              .sortable("option", "containment", false);
            b("#tools li")
              .draggable("disable");
            if(l.item.hasClass("floatLine")) {
              b("#canvas ul#sortable")
                .sortable("option", "axis", "x,y");
              b(".ui-state-highlight")
                .css({
                  "float": "left",
                  clear: "none",
          ...
          beforeStop: function (i, j) {
            b("#canvas textarea")
              .css("max-height", a.maxInputHeight);
            b("#canvas")
              .find(".ui-draggable[style*='display: none']")
              .remove()
          }
        ...
        .resizable({
          ...
          resize: function (k, l) {
            ...
            b(".canvas-resize")
              ...
              .show();
            b(".canvas-resize  .canvas-info")
              .html((l.size.width - 30) + " pixels");
            (f > l.size.width) ? b(".canvas-resize .canvas-info")
              .append("<br /><span>Ctrl + left arrow key</span>") : b(".canvas-resize  .canvas-info")
              .append("<br /><span>Ctrl + right arrow key</span>");
            f = l.size.width;
            var i = b("body")[0];
            if(i.scrollWidth > i.clientWidth) {
              if(b("#canvas")
                .width() < a.canvasMaxWidth) {
                b(window)
                  .scrollLeft(b("#canvas")
                    .width())
              } else {
      ...
      b(window)
        ...
        .scroll(function (j) {
          ...
          (p.scrollTop() < k) ? n.css({
            ...
            .removeClass("float") : n.addClass("float")
            .css({
              top: q.offset()
                .top - (q.offset()
                  .top - i.innerHeight())
          ...
          (p.scrollTop() < k) ? m.css({
            top: "1px"
          }) : m.css("top", p.scrollTop() - l - q.offset()
            .top + n.innerHeight() - 1);
          (p.scrollLeft() < r) ? o.removeClass("float")
            .css({
              left: q.offset()
                .left - p.scrollLeft()
            }) : o.css({
              left: -(p.scrollLeft() - q.offset()
                .left)
            });
      ...
      setInterval(function (i) {
        ...
        b("#container")
          .css("width", screen.width - (b("#tools")
            .width() + b("#adminmenuwrap")
            .width() + 48));
        b("#header ul")
          .css("min-width", screen.width - (b("#adminmenuwrap")
            .width() + 50));
        (b("#canvas .selected")
          .size() > 1) ? b("#merge")
          .addClass("on") : b("#merge")
      ...
      b(".ui-sortable")
        .on("mousedown", ".merge-item", function (i) {
          b(".merge-item.active")
            .removeClass("active");
          b(this)
            .addClass("active")
        });
      b(a.Selector.toolLi.selector)
        .draggable("option", "refreshPositions", true);
      b("#contextual-help-columns .contextual-help-tabs a, #contextual-help-link")
        .click(function (i) {
          b("#tools, #header")
            .css("top", "auto")
            .removeClass("float")
      ...
      b(".ui-sortable")
        .on("contextmenu", ".ui-draggable", function (i) {
          a.contextMenu(i)
        });
      b("#wpwrap")
        .mousedown(function (i) {
          b(a.Selector.contextMenu.selector)
            .hide()
        });
      b(a.Selector.contextMenu.selector)
        .click(function (i) {
      ...
      b("#contextMenu")
        .on("click", "#c_shrink", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
      ...
      b("#contextMenu")
        .on("click", "#c_expand", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
          if(i.hasClass("blockLine") == false) {
            i.css("display", "")
          }
          i.removeClass("shrink top-align")
            .addClass("expand");
          b("#p_label_width")
            .spinner("option", "disabled", false);
          b("#p_label_width")
            .val(i.find(".label")
              .width())
        });
      b("#contextMenu")
        .on("click", "#c_blockLine", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
          i.css("display", "list-item");
          i.removeClass("floatLine")
            .addClass("blockLine")
        });
      b("#contextMenu")
        .on("click", "#c_floatLine", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
          i.css("display", "list-item");
          i.removeClass("blockLine")
            .addClass("floatLine")
        });
      b("#contextMenu")
        .on("click", "#c_nextLineOff", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
          i.addClass("nextLine")
        });
      b("#contextMenu")
        .on("click", "#c_nextLineOn", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
          i.removeClass("nextLine")
        });
      b("#contextMenu")
        .on("click", "span", function (j) {
          var i = (b(".ui-sortable li.ui-draggable.active")
            .hasClass("merge")) ? b(".ui-sortable .merge-item.active") : b(a.Selector.active.selector);
      ...
      b("#contextMenu")
        .on("click", "#g_blockLine", function (j) {
          var i = b(".ui-sortable li.ui-draggable.active");
          i.css("display", "list-item");
          i.removeClass("floatLine")
            .addClass("blockLine")
      ...
      b("#contextMenu")
        .on("click", "#g_floatLine", function (j) {
          var i = b(".ui-sortable li.ui-draggable.active");
          i.css("display", "list-item");
          i.removeClass("blockLine")
            .addClass("floatLine")
      ...
      b("#contextMenu")
        .on("click", "#g_nextLineOff", function (j) {
          var i = b(".ui-sortable li.ui-draggable.active");
          i.addClass("nextLine")
        });
      b("#contextMenu")
        .on("click", "#g_nextLineOn", function (j) {
          var i = b(".ui-sortable li.ui-draggable.active");
          i.removeClass("nextLine")
        });
      b("#contextMenu")
        .on("click", "#c_delete", function (i) {
          b("#delete")
            .trigger("click")
        })
    };
