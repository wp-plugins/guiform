    ...
    a.widget("GuiForm.guiTools", {
        options: {
            ...
            Properties: {
                ...
                "Option 1": "<input type='text' class='switch_key option_1' placeholder='Enter key value' value=''>							  													<input type='text' class='switch_text option_1' placeholder='Enter text value' value=''>							  													<p>Text value accept span and img tag.</p>",
                "Option 2": "<input type='text' class='switch_key option_2' placeholder='Enter key value' value=''>																				  <input type='text' class='switch_text option_2' placeholder='Enter text value' value=''>																				  <p>Text value accept span and img tag.</p>"
            },
            Style: {
        ...
        _build: function () {
            ...
            if (a("#guiform-style").size() == 0) {
                var e = "<style type='text/css' id='guiform-style' media='all'>    									#canvas, #canvas .ui-widget{background-color: #FFFFFF;											font-family: guiform,Verdana,Geneva,sans-serif;											}											#canvas .label{											color: #333333;											}											#canvas input, #canvas textarea, #canvas select{											border: 1px solid #CCCCCC;											}										 </style>";
                a("#canvas").prepend(e)
            }
        ...
        _create: function () {
            ...
            f.on("click", "#options-list .add", function () {
                ...
                var i = '<li class="selected" style="display:none;">											<input type="radio" name="checked"><input type="text" name="label" value="Text">											<input type="text" name="value" value="value">											<span class="icon-fontawesome-webfont-106 move"></span>											<span class="icon-fontawesome-webfont-21 add"></span>											<span class="icon-fontawesome-webfont-17 delete"></span>										</li>';
                ...
                a.each(c.Options[i], function () {
                    h += '<li>											<input type="radio" name="checked"><input type="text" name="label" value="' + this + '">											<input type="text" name="value" value="' + this + '">											<span class="icon-fontawesome-webfont-106 move"></span>											<span class="icon-fontawesome-webfont-21 add"></span>											<span class="icon-fontawesome-webfont-17 delete"></span>										</li>'
                });
                a("#options-list").html("").append(h)
            }).on("click", "#clear-options", function () {
                var h = '<li>											<input type="radio" name="checked"><input type="text" name="label" value="Text">											<input type="text" name="value" value="Value">											<span class="icon-fontawesome-webfont-106 move"></span>											<span class="icon-fontawesome-webfont-21 add"></span>											<span class="icon-fontawesome-webfont-17 delete"></span>										</li>';
        ...
        _event: function () {
            ...
            d.on("keyup", "#p_short_description", function (h) {
                var i = a.trim(a(this).val());
                var g = e._form();
                g.find(".short-description").remove();
                var f = a("<p class='short-description'>");
                g.find(".wrap").append(f.text(i).clone())
            });
            ...
            d.on("keyup keydown", "#p_text_label", function (h) {
                ...
                (a.trim(a(this).val()) !== "") ? a(".ui-tabs-nav a:eq(0)").text(a.trim(a(this).val())) : a(".ui-tabs-nav a:eq(0)").html("&nbsp;");
                var i = a("<div />").html(this.value);
                i.find(":not(span)").removeTags();
                g.find(".label").html(i.html())
            });
            ...
            d.on("keyup keydown", "#p_submit_text", function (g) {
                var f = e._form();
                var h = a("<div />").html(this.value);
                h.find(":not(span)").removeTags();
                f.find("button").html(h.html())
            });
            ...
            d.on("keydown keyup", ".switch_text", function (g) {
                var h = (a.trim(a(this).val()) == "") ? "" : a.trim(a(this).val());
                var f = e._form();
                var i = a("<div />").append(h);
                i.find(":not(span, img)").removeTags();
                h = a.trim(i.html());
                if (a(this).hasClass("option_1")) {
                    f.find(".ui-button-text:first").html(h)
                } else {
                    f.find(".ui-button-text:last").html(h)
                }
            })
        },
                                    ...
                                    if (f == "p_width") {
                                        ...
                                        if (f == "p_columns") {
                                            ...
                                            if (f == "p_options_label") {
                                                ...
                                                if (f == "p_font_size") {
                                                    c.find(":header").css("font-size", d + "px");
                                                    c.find("p").css("font-size", d + "px")
                                                } else {
                                                    if (f == "p_line_height") {
                                                        c.find("p").css("line-height", d + "px")
                                                    }
                                                }
                                            }
                                        }
        ...
        get_properties: function () {
            ...
            if (d.hasClass("f_switch")) {
                ...
                var l = d.find(".switch .ui-button-text:first").html();
                var j = d.find(".switch .ui-button-text:last").html();
            ...
            if (d.hasClass("f_submit")) {
                a("#p_submit_text").val(d.find("button[type='submit']").text());
                a("#p_reset_text").val(d.find("button[type='reset']").val());
        ...
        fonts: function (e, f) {
            ...
            a.each(a.guiform.Fonts, function (g, h) {
                if (c.replace(",guiform", "").split(",")[0].replace(/['", ]/g, "") == h.split(",")[0].replace(/['", ]/g, "")) {
                    d += "<li class='list active' style='font-family: " + h + ",guiform;' data-value='" + h + ",guiform'>" + g + "</li>"
                } else {
                    d += "<li class='list' style='font-family: " + h + ",guiform;' data-value='" + h + ",guiform'>" + g + "</li>"
                }
            });
            d += "</ul></div>";
        ...
        tab_options: function () {
            ...
            if (f.hasClass("f_radio") || f.hasClass("f_checkbox")) {
                ...
                a.each(a(".wrap label", f), function () {
                    var i = a("input", this).val();
                    var j = a("span", this).text();
...
(function () {
    ...
    var a = {
        ...
        Form: {
            ...
            textarea: ["<label class='label'>Text Area</label><div class='wrap' style='width: 210px;'><textarea></textarea></div>", "MEDIUMTEXT NOT NULL"],
            ...
            file: ["<label class='label'>File Upload</label>										 		  						<div class='wrap' style='width: 210px;'>										 		  							<input type='file' file-maxsize='5' file-accept='jpg, jpeg, png, gif'>										 		  						</div>										 		  						<div class='gui-files'></div>", "TEXT NOT NULL"],
            submit: ["<div class='f_submit_wrap'><span><button type='submit' name='submit'>Submit</button></span></div>", ""],
