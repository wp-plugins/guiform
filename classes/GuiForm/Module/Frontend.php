...
class GuiForm_Module_Frontend extends GuiForm_Module {
	...
	public function footerScript(){
		...
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.mouse.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.effect.min.js"); ?>" type="text/javascript"></script>
		
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.accordion.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.datepicker.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.effect-slide.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.effect-highlight.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.spinner.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.button.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo includes_url("js/jquery/ui/jquery.ui.slider.min.js"); ?>" type="text/javascript"></script>
		
		<script src="<?php echo $guiform->assets("js/jquery.switchButton.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo $guiform->vendor("bootstrapvalidator/js/bootstrapValidator.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo $guiform->assets("js/jquery.maskedinput.min.js"); ?>" type="text/javascript"></script>
		<script src="<?php echo $guiform->assets("js/jquery-ui-timepicker-addon.js"); ?>" type="text/javascript"></script>
	...
	public function renderForm(){
		...
		<link rel="stylesheet" href="<?php echo $guiform->vendor('bootstrap/css/bootstrap.min.css'); ?>" type="text/css" media="all" />			
		<link rel="stylesheet" href="<?php echo $guiform->vendor('bootstrap/css/bootstrap-theme.min.css'); ?>" type="text/css" media="all" />			
		<link rel="stylesheet" href="<?php echo $guiform->vendor('bootstrapvalidator/css/bootstrapValidator.min.css'); ?>" type="text/css" media="all" />			
		...
		<?php if(!empty($this->_form->html)): ?>
			...
			<!--form class="GuiForm" enctype="multipart/form-data"  name="guiform" id="<?php echo $this->_randID; ?>" method="POST" action="<?php echo admin_url("admin-post.php?id=". $this->_id); ?>"-->
			<form enctype="multipart/form-data" action="<?php echo admin_url("admin-ajax.php?id=". $this->_id); ?>" class="form-horizontal guiform" id="<?php echo $this->_randID; ?>" method="POST"  >	
	...
	private function _vars($values, $method){
		...
		$vars = array('user'    => array('id' => $user->ID,
									...
									'request' => array_map('esc_sql', $_REQUEST),
									'server'  => $_SERVER,
									'session' => $_SESSION
						);
  ...
  this.resizeHeight = function(){
    ...
    var preview =  document.getElementById('guiform-preview-frame');
		if (typeof(preview) != 'undefined' && preview != null)
		{
			...
			script.src = "<?php echo $guiform->permalink($this->_form->id, '', false); ?>";
			script.id = this.Id;
			...
			var htmlCode = "<i"+"frame id=\""+this.Id+"\" src=\"<?php echo $guiform->permalink($this->_form->id, '', false); ?>\" onload=\"window.parent.scrollTo(0,0)\" allowtransparency=\"true\" frameborder=\"0\" style=\"display: inline; height: auto; width: 100%; border:none;\" scrolling=\"no\"></i"+"frame>";
