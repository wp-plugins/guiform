...
class GuiForm_Module_Widget extends WP_Widget {
  ...
  public function form($instance){
  	global $wpdb;
    $instance = wp_parse_args( (array) $instance, array( 'title' => '', 'id' => '', 'iframe' => true ) );
    ...
    $iframe_output = '<select disabled="disabled" name="'. $this->get_field_name('iframe') .'" class="widefat">';
    $iframe_output .= '<option value="true">Yes</option>';
	...
	?>
	  <p><label for="<?php echo $this->get_field_id('title'); ?>">Title: <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo attribute_escape($title); ?>" /></label></p>
		...
		<p><label for="<?php echo $this->get_field_id('iframe'); ?>">Use Iframe: <?php echo $iframe_output; ?><span>Upgrade to <a href="<?php echo GuiForm_Plugin::SERVER; ?>">GuiForm Pro</a> and unlock this feature.</span></label>
	<?php
