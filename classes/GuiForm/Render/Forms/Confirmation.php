...
class GuiForm_Render_Forms_Confirmation extends GuiForm_Render_Forms{
	...
	function scripts($hook_suffix){
		if($hook_suffix == 'toplevel_page_guiform'){
			global $guiform;
  ...
  private function _save(){
	...
	protected function _toHTML() {
		...
		<div id="guiform-manager" class="wrap form-confirmation metabox-holder">
			...
			<form method="POST">
				<table class="table-settings" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr id="row-default"  class="<?php echo ($this->var['type'] == 'default') ? '' : 'hide'; ?> row">
					...
					<tr id="row-redirect" class="<?php echo ($this->var['type'] == 'redirect') ? '' : 'hide'; ?> row">
					...
					<tr id="row-custom" class="<?php echo ($this->var['type'] == 'custom') ? '' : 'hide'; ?> row">
						<td class="border-left column-left" colspan="2">
