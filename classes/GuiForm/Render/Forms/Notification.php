...
class GuiForm_Render_Forms_Notification extends WP_List_Table {
	...
	*/
	...
	public function scripts($hook_suffix){
		if($hook_suffix == 'toplevel_page_guiform' && $_REQUEST['tab'] == 'notification'){
			global $guiform;
			...
			<form method="POST">
				...
				<table class="table-settings" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<td class="column-attachment" rowspan="4">
							<div id='attachment-item'>
								<p style="text-align: center; font-size: 21px; margin-top: 35px;">
									Upgrade to <a style="color: rgb(40, 130, 214); text-decoration: none;" href="https://www.guiform.com/">GuiForm Pro</a> to enable file attachment.
								</p>							
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<?php wp_editor(stripcslashes(html_entity_decode($this->var['message'])), 'message', array('textarea_rows' => 20)); ?>
	...
	private function _displayEntry(){
  	...
  	$html = "<div class='border-bottom border-left float-list'><h3>Form Fields</h3>";
		...
		foreach($fields as $key => $value){
			$html .= "<li data-field='{{$key}}'> $value[0]</li>";
		}
		$html .= "</ul>";
		$html .= "</div>";
