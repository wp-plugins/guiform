...
class GuiForm_Render_Uninstall extends GuiForm_Module{
	...
	private function _process(){
		...
		$options = array('GuiForm_Plugin::VERSION');
	...
	private function _deactivate(){
		$deactivate_url = wp_nonce_url('plugins.php?action=deactivate&amp;plugin=guiform/index.php', 'deactivate-plugin_guiform/index.php');
		echo '<div class="wrap">';
	...
	public function toHTML( ){
		echo "<h2>". __('Uninstall GuiForm', GuiForm_Plugin::NAME) ."</h2>";
