...
class GuiForm_Render_Forms extends WP_List_Table {
	...
	*/
	...
	public function enqueueScripts($hook_suffix){
		...
		if($hook_suffix == 'toplevel_page_guiform' || $hook_suffix == 'guiform_page_guiform_entry'){
			global $guiform;
	...
	function column_form_title($item) {
		...
		$preview_url = $guiform->permalink($item->id, '', false);
	  $actions = array(
		  					'edit'       => sprintf('<a href="?page=guiform-builder&form=%d">Edit</a>', $item->id),
		  					'settings'   => sprintf("<a href='?page=guiform&form=%d'>Settings</a>", $item->id),
