	...
	*/
	...
	function enqueueScripts($hook_suffix){
		if($hook_suffix == GuiForm_Plugin::NAME .'_page_guiform-settings'){
			...
			//wp_enqueue_style('guiform-settings', $guiform->assets('css/settings.css'), false, GuiForm_Plugin::VERSION, 'all');
			
			wp_enqueue_style('settings', $guiform->assets('css/style.css'), false, GuiForm_Plugin::VERSION, 'all');
