  ...
  /**
	...
	*/
	...
	public function admin_scripts($hook_suffix){
	    ...
	    //Load all wordpress jquery necessary files
		  ...
		  wp_enqueue_script('caret', plugins_url('guiform/js/jquery.caret.min.js'));
			...
			wp_enqueue_script('guifcolors', plugins_url('guiform/js/guifcolors.js'), array('jquery'), GUIFORM_VERSION, true);
			...
			wp_enqueue_style('guifcolors', plugins_url('guiform/css/guifcolors.css'), false, GUIFORM_VERSION, 'all');
	...
	public function create_table(){
		...
		else if(GUIFORM_VERSION == "1.4.6"){ 
			$wpdb->query("ALTER TABLE $wpdb->guiform CHANGE init init MEDIUMTEXT NULL");
		}
