...
class GuiForm extends GuiForm_API{
	...
	public function ajax_form_preview(){
		...
		echo "<div style='text-align: right; background-color: #F0F0F0;'><a href='".$guif->permalink($id)."' target='_blank' style='padding: 10px; display: inline-block; font-weight: bold;'>Full Preview</a></div>";
	...
	public function create_table(){
		...
		if(empty($version) || $version != GUIFORM_VERSION){
			...
			$options = array(array('settings', 'license_key', 'BETA TEST'),
											 ...
											 array('settings', 'autosave_time', '120'),
