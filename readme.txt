...
<li>
	<a rel="nofollow" title="Click to view full-size screenshot 1" href="//ps.w.org/guiform/assets/screenshot-1.png?rev=841169">			<img alt="guiform screenshot 1" src="//ps.w.org/guiform/assets/screenshot-1.png?rev=841169" class="screenshot">
	</a>		<p>GuiForm builder page</p>
</li>
<li>
	<a rel="nofollow" title="Click to view full-size screenshot 2" href="//ps.w.org/guiform/assets/screenshot-2.png?rev=841169">			<img alt="guiform screenshot 2" src="//ps.w.org/guiform/assets/screenshot-2.png?rev=841169" class="screenshot">
	</a>		<p>Form output</p>
</li>
<li>
	<a rel="nofollow" title="Click to view full-size screenshot 3" href="//ps.w.org/guiform/assets/screenshot-3.png?rev=841169">			<img alt="guiform screenshot 3" src="//ps.w.org/guiform/assets/screenshot-3.png?rev=841169" class="screenshot">
	</a>		<p>Entries management page</p>
</li>
<li>
	<a rel="nofollow" title="Click to view full-size screenshot 4" href="//ps.w.org/guiform/assets/screenshot-4.png?rev=841169">			<img alt="guiform screenshot 4" src="//ps.w.org/guiform/assets/screenshot-4.png?rev=841169" class="screenshot">
	</a>		<p>View entry page</p>
</li>
<li>
	<a rel="nofollow" title="Click to view full-size screenshot 5" href="//ps.w.org/guiform/assets/screenshot-5.png?rev=841169">			<img alt="guiform screenshot 5" src="//ps.w.org/guiform/assets/screenshot-5.png?rev=841169" class="screenshot">
	</a>		<p>Form management page</p>
</li>
<li>
	<a rel="nofollow" title="Click to view full-size screenshot 6" href="//ps.w.org/guiform/assets/screenshot-6.png?rev=841169">			<img alt="guiform screenshot 6" src="//ps.w.org/guiform/assets/screenshot-6.png?rev=841169" class="screenshot">
	</a>		<p>Settings page</p>
</li>
...
* Fix multiple upload error.
* Fix custom message not WYSIWYG.
* Fix notification message not recieving.
* Fix confirmation popup doesn't disappear in email setting.
* Fix screen options in all GuiForm pages.
* Change Form manager table header styles.
...
* Fix canvas width returning 0 pixels


**Version 1.6.2 - October 16, 2014**

* Fix Parse error: index.php on line 36. * Fix Parse error: syntax error, unexpected '[' in Frontend.php on line 385
...
* New Basic Tool: Confirm Password.
* New and improve export manager page.
...
* Fix 404 page not found when saving form.
* Fix email not sending.


**Version 1.5.6 - March 24, 2014**

* Add missing files from version 1.5.5.


**Version 1.5.5 - March 24, 2014**

* Fix file upload field validation error.


**Version 1.5.4 - March 10, 2014**

* Fix minor error and CSS style.
* Remove classic skin for WordPress version 3.8 below.


**Version 1.5.3 - March 8, 2014**

* Fix add email address in settings.


**Version 1.5.1 - March 8, 2014**

* Quick patch for minor bug.


**Version 1.5.0 - March 7, 2014**

* Add nonce for security validation.
* Fix conflict with themes that uses old version of jQuery.
* Fix redirect URL not saving.
* Fix select field bug.
* Fix form not displayed after pressing backspace.
...
* Fix form with dropdown field not saving.
* Fix view entry page, data are not display.
