	...
	$.widget("GuiForm.script", {
		...
		event: function(){
			...
			$doc.on('click', '#options-list .add', function(){
				...
				var html = '<tr class="show" style="display: none;">\
											<td style="width: 30%"><input type="text" name="label" value="Text"></td>\
											<td style="width: 30%"><input type="text" name="value" value="value"></td>\
											<td width="5%"><span class="fa fa-remove delete"></span></td>\
											<td width="5%"><span class="fa fa-plus add"></span></td>\
											<td width="5%"><span class="fa fa-arrows-v move"></span></td>\
										</tr>';
		...
		entryManager: function(){
			...
			$doc.on('click', '#entry-field', function(){
				
				method._type = 'display-entry';
				...
				$('<div>').guifbox({
					...
					success: function(html){
						...
						$('<div>').guifbox({
							...
							body: html,
							save: function(){
								method._type = 'display-entry-save';
								$.ajax({
									url: ajaxurl,
									data: method.data(),
									dataType: 'html',
							...
							create: function(){
								$('#guifbox-body #entry-list').sortable({
									axis: 'y',
